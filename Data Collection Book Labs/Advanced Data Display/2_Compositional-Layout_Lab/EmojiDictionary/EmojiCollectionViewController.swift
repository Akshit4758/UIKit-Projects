...
class EmojiCollectionViewController: UICollectionViewController {
    ...
    private var activeLayout: Layout = .grid {
        didSet {
    ...
    func generateColumnLayout() -> UICollectionViewLayout {
        ...
        group.contentInsets = NSDirectionalEdgeInsets(top: 0, leading: padding, bottom: 5, trailing: padding)
    ...
    func generateHeader() -> NSCollectionLayoutBoundarySupplementaryItem {
        let header = NSCollectionLayoutBoundarySupplementaryItem( layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(40.0)), elementKind: headerKind, alignment: .top)
